...
Rails.application.configure do
  ...
  config.action_cable.allowed_request_origins = [%r{(http|https)://localhost.*}, ENV.fetch('APP_DOMAIN', nil)]
  ...
  # config.active_job.queue_name_prefix = "ppay_app_production"
  ...
  config.logger = ActiveSupport::TaggedLogging.new(config.paths['log'].first, 2, 1_000 * 1024 * 1024)
