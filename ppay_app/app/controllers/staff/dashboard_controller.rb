...
module Staff
  class DashboardController < Staff::BaseController
    ...
    def calculate_total_stats
      ...
      @total_average_confirmation =
        if total_completed.positive?
          @stats.sum { |stats| stats.average_confirmation.internal * stats.completed } / total_completed
        else
          0
        end
    end
    ...
    def filtering_params
      params[:payment_filters]&.slice(:national_currency, :period, :created_from, :created_to)
    end
  end
end
