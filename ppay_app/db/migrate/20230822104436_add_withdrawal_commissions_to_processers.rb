class AddWithdrawalCommissionsToProcessers < ActiveRecord::Migration[7.0]
  def up
    ...
    change_column :users, :processer_commission, :decimal, precision: 15, scale: 10, default: 1
    change_column :users, :working_group_commission, :decimal, precision: 15, scale: 10, default: 1
